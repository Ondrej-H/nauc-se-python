...
# fuction with this arguments draw cristal instead of six hexes
draw_six_hexes(a=170, angle=150, count=12) # angle=210 is the same; # angle=135 also interesting picture
